    ...
    <div class="container mx-auto px-4 py-6 max-w-4xl">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div>
          <div class="bg-white rounded-lg shadow overflow-hidden mb-6">
            <div class="p-4 border-b border-gray-200">
              <h2 class="font-semibold">위험 분석 지도</h2>
              <p class="text-sm text-gray-500">
                화재 위험의 지리적 분포
              </p>
            </div>
            <div class="p-4">
              <div class="relative h-64 w-full bg-gray-100 rounded-md flex items-center justify-center">
                <div class="absolute top-1/4 left-1/4">
                  <div class="h-6 w-6 rounded-full bg-red-500 opacity-70"></div>
                </div>
                <div class="absolute top-1/3 right-1/3">
                  <div class="h-8 w-8 rounded-full bg-red-600 opacity-70"></div>
                </div>
                <div class="absolute bottom-1/4 right-1/4">
                  <div class="h-4 w-4 rounded-full bg-yellow-500 opacity-70"></div>
                </div>
                <MapPin class="h-8 w-8 text-blue-500" />
              </div>
              <div class="flex justify-between mt-4">
                <div class="flex items-center">
                  <div class="h-3 w-3 rounded-full bg-red-600 mr-1"></div>
                  <span class="text-xs">심각</span>
                </div>
                <div class="flex items-center">
                  <div class="h-3 w-3 rounded-full bg-orange-500 mr-1"></div>
                  <span class="text-xs">높음</span>
                </div>
                <div class="flex items-center">
                  <div class="h-3 w-3 rounded-full bg-yellow-500 mr-1"></div>
                  <span class="text-xs">중간</span>
                </div>
                <div class="flex items-center">
...
const activeReports = ref([
  {
    ...
    confirmedAt: new Date().toISOString() // 소방관 확인 시간
  },
  {
    id: "2",
    username: "안전제일",
