<template>
        ...
        <div class="container mx-auto max-w-lg px-4">
          <div class="flex justify-between items-center">
            <div class="flex items-center">
              ...
              <h1 class="font-bold text-xl text-gray-900">화재 지도</h1>
            </div>
            <div class="flex items-center space-x-2">
              ...
              <button 
                @click="fitAllMarkersInView" 
                class="p-2 rounded-full bg-gray-100 hover:bg-gray-200"
              >
                <ZoomOut class="h-5 w-5 text-gray-700" />
              </button>
            </div>
          </div>
        </div>
  ...
  import { AlertTriangle, CheckCircle, ChevronLeft, Locate, ZoomOut } from 'lucide-vue-next';
