...
class VideoTranscoder:
    ...
    async def transcode_video(self, file_content: bytes, video_id: str) -> Tuple[bytes, str]:
        """
        ...
        with tempfile.NamedTemporaryFile(suffix='.mp4', delete=False) as input_temp, \
             tempfile.NamedTemporaryFile(suffix='_240p.mp4', delete=False) as output_temp:
            ...
            try:
                ...
                stream = ffmpeg.filter(stream, 'scale', width=-1, height=240)
                stream = ffmpeg.output(stream, output_temp.name,
                ...
                output_filename = f"{video_id}_240p.mp4"
    ...
    def get_video_info(video_path: str) -> dict:
        ...
        try:
            ...
            return {
                ...
                'fps': eval(video_info['r_frame_rate'])  # converts string like '30/1' to float
            }
        except Exception as e:
